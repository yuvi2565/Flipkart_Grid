...
function updateCartTotal() {
  ...
  for (var i = 0; i < cartRows.length; i++) {
    ...
    console.log(priceElement.innerText.replace("eth", " "));
    var price = parseFloat(Number(priceElement.innerText.replace("eth", " ")));
...
function token_click() {
  ...
  if (count > 0) {
    ...
    for (var i = 0; i < cartRows.length; i++) {
      ...
      var currentPrice = parseFloat(priceElement.innerText.replace("eth", ""));
